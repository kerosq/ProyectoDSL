...
namespace IPS.UMLSPF
{
	...
	/// </remarks>
	public partial class UMLSPFHelpKeywordHelper : UMLSPFHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new UMLSPFHelpKeywordHelper.
		/// </summary>
		protected UMLSPFHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the UMLSPFHelpKeywordHelper.
		/// </summary>
		public static UMLSPFHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class UMLSPFHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new UMLSPFHelpKeywordHelperBase.
		/// </summary>
		protected UMLSPFHelpKeywordHelperBase()
			: base() { }
