...
namespace IPS.UMLSPF
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.UMLSPFEditorFactoryId)]
	internal partial class UMLSPFEditorFactory : UMLSPFEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new UMLSPFEditorFactory.
		/// </summary>
		public UMLSPFEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class UMLSPFEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected UMLSPFEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new UMLSPFDocData(this.ServiceProvider, typeof(UMLSPFEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new UMLSPFDocView(docData, this.ServiceProvider);
		}
	}
}
