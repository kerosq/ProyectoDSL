...
namespace IPS.UMLSPF
{
	...
	/// </summary>
	internal partial class UMLSPFCommandSet : UMLSPFCommandSetBase
	{
		/// <summary>
	...
	/// </summary>
	internal abstract class UMLSPFCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		...
		{
			UMLSPFExplorerToolWindow explorer = this.UMLSPFExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected UMLSPFDocData CurrentUMLSPFDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as UMLSPFDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected UMLSPFDocView CurrentUMLSPFDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as UMLSPFDocView;
			}
		}
		...
		/// </summary>
		protected UMLSPFExplorerToolWindow UMLSPFExplorerToolWindow
		{
			get
			{
				UMLSPFExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(UMLSPFExplorerToolWindow), true) as UMLSPFExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				UMLSPFExplorerToolWindow explorerWindow = this.UMLSPFExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class UMLSPFClipboardCommandSet : UMLSPFClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new UMLSPFClipboardCommandSet.
		/// </summary>
		public UMLSPFClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class UMLSPFClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new UMLSPFClipboardCommandSetBase.
		/// </summary>
		protected UMLSPFClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
