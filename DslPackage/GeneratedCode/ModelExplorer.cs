...
namespace IPS.UMLSPF
{
	...
	/// </summary>
	internal partial class UMLSPFExplorer : UMLSPFExplorerBase
	{
		/// <summary>
		/// Constructs a new UMLSPFExplorer.
		/// </summary>
		public UMLSPFExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the UMLSPFExplorerToolWindow.
	/// </summary>
	internal abstract class UMLSPFExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new UMLSPFExplorerBase.
		/// </summary>
		protected UMLSPFExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.UMLSPFExplorerMenu;
			}
		}
