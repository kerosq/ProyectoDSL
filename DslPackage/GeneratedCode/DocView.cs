...
namespace IPS.UMLSPF
{
	...
	/// </summary>
	internal partial class UMLSPFDocView : UMLSPFDocViewBase
	{
		/// <summary>
		/// Constructs a new UMLSPFDocView.
		/// </summary>
		public UMLSPFDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class UMLSPFDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new UMLSPFDocView.
		/// </summary>
		protected UMLSPFDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			UMLSPFDocDataBase docData = this.DocData as UMLSPFDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for UMLSPFDocViewBase should be an UMLSPFDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::IPS.UMLSPF.UMLSPFDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::IPS.UMLSPF.UMLSPFDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::IPS.UMLSPF.UMLSPFToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::IPS.UMLSPF.UMLSPFToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.UMLSPFDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::IPS.UMLSPF.UMLSPFHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::IPS.UMLSPF.UMLSPFHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::IPS.UMLSPF.UMLSPFHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
